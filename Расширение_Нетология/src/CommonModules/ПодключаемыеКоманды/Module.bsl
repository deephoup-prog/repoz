...
Процедура ДополнениеФормыДокумента(Форма) Экспорт
	ОбщаяФормаЭлементов.ДополнитьФорму(Форма);	
КонецПроцедуры
...
Процедура ДополнитьФорму(Форма) Экспорт 
	...
	Если ИмяФормы = "Документ.ЗаказПокупателя.Форма.ФормаДокумента" Тогда
		ДобавитьПолеКонтактноеЛицоВГруппаЩапкаПраво(Форма);	
	ИначеЕсли ИмяФормы = "Документ.ПоступлениеТоваров.Форма.ФормаДокумента" Тогда
		ДобавитьПолеКонтактноеЛицоВГруппаЩапкаПраво(Форма);	
	ИначеЕсли ИмяФормы = "Документ.РеализацияТоваровУслуг.Форма.ФормаДокумента" Тогда
		ДобавитьПолеКонтактноеЛицоВГруппаЩапкаПраво(Форма);	
	ИначеЕсли ИмяФормы = "Документ.ОплатаОтПокупателя.Форма.ФормаДокумента" Тогда
		ВставитьПолеКонтакноеЛицоНаФормуПередСуммойДокумента(Форма);	
...
Процедура ДобавитьПолеКонтактноеЛицоВГруппаЩапкаПраво(Форма)
...
Процедура ВставитьПолеКонтакноеЛицоНаФормуПередСуммойДокумента(Форма)
	
	ПолеВвода = Форма.Элементы.Добавить("КонтакноеЛицо", Тип("ПолеФормы"), Форма.Элементы.СуммаДокумента);
	ПолеВвода.Вид = ВидПоляФормы.ПолеВвода;
	ПолеВвода.ПутьКДанным = "Объект.КонтактноеЛицо";	
